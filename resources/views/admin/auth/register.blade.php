        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('admin.dashboard.store') }}"> {{-- da 34an lama a5zen el data bta3et el admin ywdeeny 3ala el path da y3nii--}}
                        @csrf
                        ...
                        <div class="row mb-3">
                            <label for="admin_key" class="col-md-4 col-form-label text-md-end">Admin Key 🗝️</label>
